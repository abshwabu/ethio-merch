                    ...
                    <div class="register-form form-item ">
                        <form class="form-stl" action="{{route('register')}}" name="frm-login" method="post" >
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="text" id="frm-reg-lname" name="reg-lname" placeholder="Last name*":value="name"  required autocomplete="name">
                            </fieldset>
                            <fieldset class="wrap-input">
                            ...
                            <p>Alredy has ancount? <a href="{{route('login')}}">login</a></p>
                        </form>
                    </div>											
                </div>
